...
//        System.out.println(q1.getSquare());
        ...
        l.setCOORDINATE(-150, 25, 55, 30); // Попали в if в классе Shape.
        System.out.println(l);

        l.setCOORDINATE(150, 25, 55, 30); // Не попали в if в классе Shape.
        System.out.println(l);

        System.out.println(Geom.MAX_COORDINATE + " " + Geom.MIN_COORDINATE);
        Geom.showInterval();
